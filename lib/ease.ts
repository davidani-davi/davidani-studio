// Shared motion tokens, vendored from beui.dev/components.
// Springs are the canonical physics used across the beUI components in
// components/motion; easing curves mirror the CSS custom properties in
// globals.css. Strong custom variants — defaults like `ease-in`/`ease-out`
// feel weak.
