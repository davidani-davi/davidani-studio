...
it('uses the new generated front as canvas for all later Vision and Celine 2 views', () => {
  for (const id of ['studio 97','crop 97','studio 99','crop 99','low 97','low 99','studio 100','crop 100','low 100'])
...
it('leaves front generation and other models intact', () => {
  ...
  expect(houseModelContinuity('studio 98','side','','https://studio.test')).toBeNull();
});
