"use client";
// beui.dev/components/motion/tabs — vendored, unmodified.
...
export function TabsContent({
  ...
  const reduce = useReducedMotion();
  const active = current === value;
  // Inactive panels stay mounted but hidden, so their content is present in
  // the server-rendered HTML for crawlers and assistive tech.
  if (!active) {
    return (
