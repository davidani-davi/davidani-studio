"use client";
// beui.dev/components/motion/button — vendored. Magnetic and Metallic variants
// were not brought across; nothing in this studio needs a cursor-tracked pull
// or a chrome reflection on a button.
